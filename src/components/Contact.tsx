            ...
            <div className="bg-white rounded-xl p-8 shadow-lg h-full">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(18)99117-6034 (Whatsapp)</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+55 (18)99117-6034</p>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="https://github.com/josuegeraldommfata" target="_blank" rel="noopener noreferrer" className="bg-gray-100 p-3 rounded-full text-gray-600 hover:bg-portfolio-indigo hover:text-white transition-all">
                  ...
                  <a href="#" target="_blank" rel="noopener noreferrer" className="bg-gray-100 p-3 rounded-full text-gray-600 hover:bg-portfolio-indigo hover:text-white transition-all">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
