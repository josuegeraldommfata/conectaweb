        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div className="order-2 lg:order-1">
            ...
            <h1 className="text-4xl md:text-6xl font-serif font-bold mb-4 text-portfolio-blue animate-slide-up">
              Engenheiro De Software <span className="text-gradient">Full Stack Web & Mobile  Sênior</span>&<span className="text-gradient">Mobile.</span>
            </h1>
            <p className="text-gray-600 text-lg mb-8 max-w-lg animate-slide-up" style={{animationDelay: '0.2s'}}>
              Sou Freelancer Como Engenheiro de Software Full Stack developer e UI Designer. Desenvolvo Interfaces Modernas E De Alta Qualidade, Concentrado Em Performance, Animações Criativas E Soluções, Responsividade E SEO,Com Mais De 13 Anos De Experiência.
            </p>
            <div className="flex flex-wrap gap-4 animate-slide-up" style={{animationDelay: '0.4s'}}>
              <a
                href="https://wa.me/5518991176034?text=Ol%C3%A1%2C%20gostaria%20de%20pedir%20um%20or%C3%A7amento!!"
                target="_blank"
